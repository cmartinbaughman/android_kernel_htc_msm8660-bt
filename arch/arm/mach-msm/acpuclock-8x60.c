...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[22] = {1536000,  1, 0x1D, 1225000, 1275000, 4},
	[23] = {1566000,  1, 0x1E, 1225000, 1275000, 4},	
	[24] = {1620000,  1, 0x1F, 1250000, 1350000, 4},
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_anthrax[] = {
  ...
  { {1, 1}, 1350000,  ACPU_SCPLL, 0, 0, 1, 0x19, L2(18), 1187500, 0x03006000},
  ...
  { {1, 1}, 1536000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(22), 1250000, 0x03006000},
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(23), 1250000, 0x03006000},
  { {1, 1}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(24), 1250000, 0x03006000},
  { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(24), 1300000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(24), 1350000, 0x03006000},
  { {0, 0}, 0 },
};
